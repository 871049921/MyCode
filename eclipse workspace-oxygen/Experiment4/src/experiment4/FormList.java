...
//	}
	...
	public static OrnamentalAnimalShow setRandomOrnamentalAnimalShow(int number) {
		...
		switch (i) {
		case 1:
			OrnamentalAnimalShow canary = new Canary(number, names.get(1), (int)(Math.random() * 100), "雄性", (int)(Math.random() * 5 + 1));
			numberOfOrnamentalAnimal ++;
			return canary;
		case 2:
			OrnamentalAnimalShow parrot = new Parrot(number, names.get(1), (int)(Math.random() * 100), "雄性", (int)(Math.random() * 5 + 1));
			numberOfOrnamentalAnimal ++;
			return parrot;
		}
		return null;
